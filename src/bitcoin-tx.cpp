...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s shtcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  shtcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shtcoin transaction") + "\n" +
              "  shtcoin-tx [options] -create [commands]   " + _("Create hex-encoded shtcoin transaction") + "\n" +
              "\n";
