...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 10745
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 10746
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 20745
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 20746
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 10745
	%{_sbindir}/semanage port -d -p tcp 10746
	%{_sbindir}/semanage port -d -p tcp 20745
	%{_sbindir}/semanage port -d -p tcp 20746
