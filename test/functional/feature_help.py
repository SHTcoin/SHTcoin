...
"""Verify that starting shtcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shtcoin with -h for help text")
        ...
        self.log.info("Start shtcoin with -version for version information")
