...
* shtcoin.conf: contains configuration settings for shtcoind or shtcoin-qt
* shtcoind.pid: stores the process id of shtcoind while running
...
* debug.log: contains debug information and general logging generated by shtcoind or shtcoin-qt
