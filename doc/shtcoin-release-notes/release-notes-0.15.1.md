Shtcoin Core version *0.15.1* is now available from:

  <https://download.shtcoin.org/shtcoin-0.15.1/>
...
A number of changes to the way Shtcoin Core deals with peer connections and invalid blocks
